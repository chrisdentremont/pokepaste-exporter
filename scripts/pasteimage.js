...
function replaceMissingImages() {
  if (window.location.href.includes("pokepast")) {
    let images = document.querySelectorAll("img[class='img-pokemon']");
    ...
    images.forEach((image) => {
      ...
      if (text.includes("gender-f") && pokeJson[name].has_female == true) {
        ...
        image.setAttribute(
          "src",
          "https://raw.githubusercontent.com/chrisdentremont/pokemon-home-images/refs/heads/main/home/female/" +
            id +
            ".png"
        );
      } else if (!isShiny) {
        ...
        image.setAttribute(
          "src",
          "https://raw.githubusercontent.com/chrisdentremont/pokemon-home-images/refs/heads/main/home/" +
            id +
            ".png"
        );
      } else {
        ...
        image.setAttribute(
          "src",
          "https://raw.githubusercontent.com/chrisdentremont/pokemon-home-images/refs/heads/main/home/shiny/" +
            id +
            ".png"
        );
      }
      ...
      if (text[0] != "<") {
        preNode.innerHTML = text.replace(
          originalName,
          '<span class="type-' +
            pokeJson[name].type1 +
            '">' +
